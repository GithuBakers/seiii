...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/worker/setting': {
      component: dynamicWrapper(app, ['user'], () => import('../routes/Worker/Setting')),
    },
    '/worker/task-list': {
    ...
    '/initiator/new-criterion':{
      component:dynamicWrapper(app,['initiatorCriterion'],()=>import('../routes/Initiator/NewCriterion')),
    },
    '/initiator/all-criterion':{
      component:dynamicWrapper(app,['initiatorCriterion'],()=>import('../routes/Initiator/AllCriterion')),
    },
    '/initiator/my-criterion':{
